        ...
        document.getElementsByClassName('commerce-full-content')[0].innerHTML = `
            <div class="application-preferences">
                ...
                <div class="app-prefs-section visual">
                    ...
                    <ul class="settings-list visual">
                        ...
                        <li class="app-prefs-button">
                            ...
                            <label id="updateThemes" class="list-button list-element" onclick="AMSettings.themes.updateThemes()">Update Themes</label>
                            <span class="app-prefs-help typography-title-3-tall" style="color: var(--systemRed);">Running this will delete the themes directory. If you have made a theme, store it elsewhere until it says Updated.</span>
                        </li>
                        <li class="app-prefs-dropdown">
                            ...
                            <span class="app-prefs-help typography-title-3-tall">macOS Emulation shows the 'stoplights' that are well known for all macOS users and adjusts other UI elements to resemble the macOS Music App. Selecting the right option shows a more Windows-like representation with the stoplights replacing the usual close, minimize and maximize buttons. For mac users its suggested that you disable this for the best experience. Having this disabled will make the application use the operating system's frame.</span>
                        </li>
                        <li class="app-prefs-divider header-nav">
                        ...
                        <li class="app-prefs-dropdown">
                            ...
                            <select class="form-dropdown-select list-element" name="transparencyMaximumRefreshRate" id="transparencyMaximumRefreshRate">
                                <option disabled>Select one</option>
                                <option value=''>Disabled</option>
                        ...
                        <li class="app-prefs-toggle">
                            ...
                            <span class="app-prefs-help typography-title-3-tall">Less stable, but allows for lyrics translation and better lyrics detection</span>
                        </li>
                        <li class="app-prefs-dropdown">
                ...
                <div class="app-prefs-section advanced">
                    <div class="app-prefs-title header-nav" style="height: 10px;" onclick="AMSettings.revealCollapse()">
                        <div class="header-nav-content">
                    ...
                    <ul class="settings-list advanced" id="advanced">
                        ...
                        <li class="app-prefs-toggle">
                            ...
                            <span class="app-prefs-help typography-title-3-tall">Enabling this makes the application load <a href="https://beta.music.apple.com">beta.music.apple.com</a> instead of <a href="https://music.apple.com">music.apple.com</a>. Disabling this will provide a limited experience on the app.</span>
                        </li>
                        <li class="app-prefs-toggle">
